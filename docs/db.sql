...
CREATE TABLE TRANSFER_EVENT (
    ...
    PRIMARY KEY (ID, BLOCK_NUMBER),  -- Include partition key in PK
    UNIQUE(BLOCK_NUMBER, LOG_INDEX)
) PARTITION BY RANGE (BLOCK_NUMBER);

CREATE TABLE transfer_event_p1 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (0) TO (5000000);

CREATE TABLE transfer_event_p2 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (5000000) TO (10000000);

CREATE TABLE transfer_event_p3 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (10000000) TO (11000000);

CREATE TABLE transfer_event_p4 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (11000000) TO (12000000);

CREATE TABLE transfer_event_p5 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (12000000) TO (13000000);

CREATE TABLE transfer_event_p6 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (13000000) TO (14000000);

CREATE TABLE transfer_event_p7 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (14000000) TO (15000000);

CREATE TABLE transfer_event_p8 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (15000000) TO (16000000);

CREATE TABLE transfer_event_p9 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (16000000) TO (17000000);

CREATE TABLE transfer_event_p10 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (17000000) TO (18000000);

CREATE TABLE transfer_event_p11 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (18000000) TO (19000000);

CREATE TABLE transfer_event_p12 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (19000000) TO (20000000);

CREATE TABLE transfer_event_p13 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (20000000) TO (21000000);

CREATE TABLE transfer_event_p14 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (21000000) TO (22000000);

CREATE TABLE transfer_event_p15 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (22000000) TO (23000000);

CREATE TABLE transfer_event_p16 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (23000000) TO (24000000);

CREATE TABLE transfer_event_p17 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (24000000) TO (25000000);

CREATE TABLE transfer_event_p18 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (25000000) TO (26000000);

CREATE TABLE transfer_event_p19 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (26000000) TO (27000000);

CREATE TABLE transfer_event_p20 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (27000000) TO (28000000);

CREATE TABLE transfer_event_p21 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (28000000) TO (29000000);

CREATE TABLE transfer_event_p22 PARTITION OF TRANSFER_EVENT
    FOR VALUES FROM (29000000) TO (30000000);
    

CREATE INDEX IDX_TRANSFER_EVENT_BLOCK_NUMBER_BRIN ON TRANSFER_EVENT USING brin(BLOCK_NUMBER);
...
CREATE TABLE TOKEN_AMOUNT (
    ...
    PRIMARY KEY (ID, TOKEN_ADDRESS),  -- Include partition key in PK
    UNIQUE(TOKEN_ADDRESS, OWNER_ADDRESS)
) PARTITION BY HASH (TOKEN_ADDRESS);

CREATE TABLE TOKEN_AMOUNT_p0 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 0);
CREATE TABLE TOKEN_AMOUNT_p1 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 1);
CREATE TABLE TOKEN_AMOUNT_p2 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 2);
CREATE TABLE TOKEN_AMOUNT_p3 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 3);
CREATE TABLE TOKEN_AMOUNT_p4 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 4);
CREATE TABLE TOKEN_AMOUNT_p5 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 5);
CREATE TABLE TOKEN_AMOUNT_p6 PARTITION OF TOKEN_AMOUNT
    FOR VALUES WITH (MODULUS 8, REMAINDER 6);
CREATE TABLE TOKEN_AMOUNT_p7 PARTITION OF TOKEN_AMOUNT
